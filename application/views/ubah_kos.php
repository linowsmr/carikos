                                ...
                                <form action="<?php echo site_url('kos/update_data')?>" method="post">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <h4>Nama Kos</h4>
                                            <input type="name" class="form-control" name="nama" value="<?php echo $row->namaKos ?>">
                                        </div>
                                        <div class="form-group">
                                            <h4>Alamat Kos</h4>
                                            <textarea class="form-control" rows="3" name="alamat"><?php echo $row->alamatKos ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <h4>Telepon Kos</h4>
                                            <input type="name" class="form-control" name="telepon" value="<?php echo $row->teleponKos ?>">
                                        </div>
                                        <div class="form-group">
